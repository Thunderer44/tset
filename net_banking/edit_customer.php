        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    ...
                    <option value="ghaziabad" <?php if ($branch == 'ghaziabad') {?> selected="selected" <?php }?>>Ghaziabad</option>
                    <option value="noida" <?php if ($branch == 'noida') {?> selected="selected" <?php }?>>Noida</option>
                    <option value="chandigarh" <?php if ($branch == 'chandigarh') {?> selected="selected" <?php }?>>Chandigarh</option>
                    <option value="merut" <?php if ($branch == 'merut') {?> selected="selected" <?php }?>>Merut</option>
                </select>
            </div>
        </div>
